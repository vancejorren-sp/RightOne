      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-12 gap-12 items-center">
        <div className="lg:col-span-7 xl:col-span-6">
          <div className="relative z-10">
            <h1 className="flex flex-col text-5xl md:text-6xl lg:text-[5rem] xl:text-[5.5rem] font-serif font-bold tracking-tight text-slate-900 leading-[1.1] mb-8">
              {/* Line 1: Find your */}
              <LineReveal text="Find your" />

              {/* Line 2: right one. */}
              <div className="text-indigo-600 italic font-normal lowercase leading-[1.2]">
          ...
          <ScrollReveal className="flex flex-col sm:flex-row items-center gap-4 lg:gap-6">
            <a 
              href="#book" 
          ...
          <ScrollReveal className="mt-12 lg:mt-16 flex items-center space-x-4">
        ...
        <div className="lg:col-span-5 xl:col-span-6 relative flex justify-center lg:justify-end">
          <ScrollReveal className="w-full max-w-[500px] lg:max-w-none">
            ...
            {/* Static UI element (animation removed) */}
            <div className="absolute -bottom-4 -left-4 lg:-bottom-8 lg:-left-8 z-20 bg-white p-6 lg:p-8 rounded-2xl lg:rounded-3xl shadow-2xl border border-slate-50 max-w-[240px] lg:max-w-xs">
